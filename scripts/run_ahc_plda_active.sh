...
cmd3="python3 household_simulation.py --config configs/offline/config_xvector_trimmed_2sec_plda_diag_offline_ahc_plda_sph.yaml --debug ${DEBUG} --verbose ${VERBOSE}"
#
